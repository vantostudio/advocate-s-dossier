...
export const metadata: Metadata = {
  title: "Resume",
  description: "An interactive résumé — education, skills, and downloads.",
  openGraph: { title: "Resume", description: "Interactive résumé and downloads." },
};
        ...
        <aside className="md:col-span-4 space-y-10">
          <div>
            ...
            <ul className="mt-3 space-y-1 text-sm">
              <li>Nairobi, Kenya</li>
              <li>
                <a href="mailto:hello@example.law" className="hover:text-bronze">
                  hello@example.law
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm">
              <li className="flex justify-between border-b border-border pb-1">
                <span>English</span>
                <span className="text-ink-muted">Native</span>
              </li>
              <li className="flex justify-between border-b border-border pb-1">
                <span>Kiswahili</span>
                <span className="text-ink-muted">Native</span>
            ...
            <ul className="mt-4 space-y-8">
              {[
                [
                  ...
                  "First-class trajectory. Concentrations in Constitutional, Commercial, and Technology Law.",
                ],
          ...
          <section>
            ...
            <div className="mt-4 grid grid-cols-2 gap-x-6 gap-y-2 text-sm md:grid-cols-3">
              {[
                ...
                <span key={s} className="border-b border-border pb-1">
                  {s}
                </span>
              ))}
            </div>
