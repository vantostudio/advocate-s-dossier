...
export function SiteFooter() {
  return (
    <footer className="border-t border-border bg-paper grain">
      <div className="mx-auto max-w-[1400px] px-5 sm:px-6 md:px-12">
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-10 py-14 md:grid-cols-2 lg:grid-cols-12 lg:gap-8">
            ...
            <ul className="mt-4 space-y-2.5 text-sm">
              <li>
                <a
                  ...
                  className="link-underline whitespace-nowrap text-charcoal hover:text-bronze"
                >
