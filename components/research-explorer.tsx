...
const PAPERS = [
  {
    title: "Devolution and the Silent Constitution: On Article 203(1)",
    type: "Working Paper",
    year: "2026",
    read: 14,
    tags: ["Constitutional", "Devolution"],
    abstract:
      "A close reading of the equitable-share formula and the doctrinal room for judicial supervision without displacing the political branch.",
  },
  {
    title: "Cross-Border Data Flows Under the DPA 2019",
    type: "Essay",
    year: "2026",
    read: 9,
    tags: ["Data Protection", "Technology"],
    abstract:
      "How Kenya's Data Protection Act interacts with regional trade frameworks — and what the Commissioner's early rulings actually decided.",
  },
  {
    title: "Horizontal Rights in Privatised Utilities",
    type: "Case Note",
    year: "2025",
    read: 6,
    tags: ["Human Rights", "Constitutional"],
    abstract:
      "Reading Mitu-Bell forward: the anatomy of a socio-economic-rights claim against a private licensee.",
  },
  {
    title: "Reasonable in Law, Reasonable in Fact",
    type: "Essay",
    year: "2025",
    read: 11,
    tags: ["Administrative", "Judicial Review"],
    abstract:
      "The reasonableness standard in Kenyan administrative law after Republic v Kenya Revenue Authority — a proposed doctrinal map.",
  },
  {
    ...
    abstract:
      "Classification, control, and the missing fourth factor: what platform-worker jurisprudence borrows from ILO Recommendation 198.",
  },
];
    ...
    () =>
      PAPERS.filter(
        (p) =>
          ...
          (q === "" ||
            (p.title + p.abstract + p.tags.join(" ")).toLowerCase().includes(q.toLowerCase())),
      ),
    [q, type],
  );
    ...
    <>
      <div className="grid grid-cols-1 gap-6 border-y border-border py-6 md:grid-cols-12 md:gap-8">
        <div className="md:col-span-6">
          <label htmlFor="q" className="folio">
            Search
          </label>
          <input
            id="q"
      ...
      <div className="mt-4 folio">
        {filtered.length} of {PAPERS.length} entries
      </div>
            ...
            <div className="md:col-span-9">
              ...
              <div className="mt-5 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm">
                <div className="flex flex-wrap gap-2">
                  {p.tags.map((t) => (
                    <span key={t} className="folio border border-border px-2 py-0.5">
                      {t}
                    </span>
                  ))}
                </div>
